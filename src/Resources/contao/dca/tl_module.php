...
$GLOBALS['TL_DCA']['tl_module']['palettes']['personalDataExtension'] = '{title_legend},name,headline,type;{config_legend},editable'. ( class_exists( 'Contao\Newsletter' ) ? ',newsletters' : '' ) .';{redirect_legend},jumpTo;{template_legend:hide},memberExtendedTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID';
